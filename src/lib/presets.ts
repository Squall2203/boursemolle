...
export const PRESETS: Preset[] = [
  ...
  },
  {
    id: "garp",
    name: "GARP mondial",
    description: "Growth At a Reasonable Price — croissance soutenue sans surpayer : qualité + croissance élevées, valorisation acceptable",
    criteria: [
      { label: "Score Crois.", value: "> 7" },
      { label: "Score Qual.", value: "> 6" },
      { label: "Score Valo.", value: "> 5" },
      { label: "P/E", value: "< 35" },
    ],
    filters: {
      pe: { min: 0, max: 35 },
      ...
      scoreCroissance: { min: 7, max: 10 },
      scoreQualite: { min: 6, max: 10 },
      scoreValorisation: { min: 5, max: 10 },
      freshnessMaxDays: 0,
      market: "" as const,
      indices: [],
      sectors: [],
