...
const CAC_NEXT20: TickerEntry[] = [
  ...
  { ticker: "BB.PA", expectedName: "BioMérieux", indices: ["CAC Next 20"] },
...
// ─── CAC Mid 60 (60 values — selection of most liquid) ───
const CAC_MID60: TickerEntry[] = [
  ...
  { ticker: "CO.PA", expectedName: "Casino", indices: ["CAC Mid 60"] },
  { ticker: "COV.PA", expectedName: "Covivio", indices: ["CAC Mid 60"] },
  { ticker: "DBG.PA", expectedName: "Deutsche Börse", indices: ["CAC Mid 60"] },
  { ticker: "DIM.PA", expectedName: "Sartorius Stedim", indices: ["CAC Mid 60"] },
  { ticker: "ELE.PA", expectedName: "Elior", indices: ["CAC Mid 60"] },
  { ticker: "ELIOR.PA", expectedName: "Elior Group", indices: ["CAC Mid 60"] },
  { ticker: "EMC.PA", expectedName: "Euroapi", indices: ["CAC Mid 60"] },
  { ticker: "FDJ.PA", expectedName: "FDJ", indices: ["CAC Mid 60"] },
  { ticker: "FP.PA", expectedName: "Faurecia / Forvia", indices: ["CAC Mid 60"] },
  { ticker: "GFC.PA", expectedName: "Gecina", indices: ["CAC Mid 60"] },
  { ticker: "GBT.PA", expectedName: "Guerbet", indices: ["CAC Mid 60"] },
  { ticker: "ILD.PA", expectedName: "ID Logistics", indices: ["CAC Mid 60"] },
  { ticker: "ING.PA", expectedName: "Ingenico", indices: ["CAC Mid 60"] },
  ...
  { ticker: "LOUP.PA", expectedName: "Loup", indices: ["CAC Mid 60"] },
  ...
  { ticker: "SPB.PA", expectedName: "Solutions 30", indices: ["CAC Mid 60"] },
  ...
  { ticker: "VRAP.PA", expectedName: "Virbac", indices: ["CAC Mid 60"] },
...
const AEX25: TickerEntry[] = [
  ...
  { ticker: "DSM.AS", expectedName: "DSM-Firmenich", indices: ["AEX 25"] },
  { ticker: "EXOR.AS", expectedName: "Exor", indices: ["AEX 25"] },
